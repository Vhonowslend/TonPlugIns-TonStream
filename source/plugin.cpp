...
static auto initializer = Steinberg::ModuleInitializer([]() { core = tonplugins::core::instance("TonStream"); });

static auto finalizer = Steinberg::ModuleTerminator([]() { core.reset(); });
